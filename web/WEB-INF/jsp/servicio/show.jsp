...
<head>
    ...
    <title>Detalles del Servicio ${bo.nombre}</title>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header" data-background-color="purple">
                                ...
                                <p class="category">Proveedor: ${servicio.proveedor.nombre}. Servicio: ${servicio.nombre}</p>
                            </div>
                            ...
                            <div class="card-content table-responsive">
                                <table class="table">
                                    ...
                                    <c:forEach items="${servicio.etapas}" var="bo">
                                        <tr>
                                            <td>${bo.nombre}</td>
                                        </tr>
                                    </c:forEach>
                                ...
                                <a data-toggle="modal" data-target="#myModal" style="cursor: pointer" class="btn btn-primary pull-right"><i class="material-icons">playlist_add</i> Nueva Etapa</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<jsp:include page="../etapa/create.jsp"/>
