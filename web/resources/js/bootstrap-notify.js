	...
	$.extend(Notify.prototype, {
						...
						switch (cmd) {
							...
							case "icon":
								...
								if (self.settings.icon_type.toLowerCase() === 'class') {
									...
									if (!$icon.is('com.bolivarSoftware.apolo.web.img')) {
										$icon.find('com.bolivarSoftware.apolo.web.img');
									}
		...
		setIcon: function () {
			...
			if (this.settings.icon_type.toLowerCase() === 'class') {
				...
				if (this.$ele.find('[data-notify="icon"]').is('com.bolivarSoftware.apolo.web.img')) {
					this.$ele.find('[data-notify="icon"]').attr('src', this.settings.content.icon);
				} else {
					this.$ele.find('[data-notify="icon"]').append('<com.bolivarSoftware.apolo.web.img src="' + this.settings.content.icon + '" alt="Notify Icon" />');
				}
			}
		},
